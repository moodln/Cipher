                ...
                <div className="sidebar-section-div">
                    <div className="sidebar-section">
                        <button className="sidebar-button">
                            <svg className="problems-svg" xmlns="http://www.w3.org/2000/svg" class="bi bi-code-slash" viewBox="0 0 16 16">
                    ...
                    <div className="sidebar-section">
                        <button className="sidebar-button">
                            <svg className="problems-svg" xmlns="http://www.w3.org/2000/svg" class="bi bi-files" viewBox="0 0 16 16">
                    ...
                    <div className="sidebar-section">
                        <button className="sidebar-button">
                            <svg className="problems-svg" xmlns="http://www.w3.org/2000/svg" class="bi bi-people" viewBox="0 0 16 16">
